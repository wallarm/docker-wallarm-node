...
csr = OpenSSL::X509::Request.new File.read 'csr_server.pem'
...
# csr_cert.add_extension extension_factory.create_extension('extKeyUsage', 'serverAuth')

csr_cert.sign node_api_root_key, OpenSSL::Digest::SHA256.new

open 'node_server_cert.pem', 'w' do |io|
